...
if (isset($_POST['boleta'])) {
    ...
    //INSERT INTO `cliente` (`cod_cliente`, `dni`, `nombre`, `fecha_nac`, `correo`) VALUES ('0001', '74433455', 'franko', '22/07/22', 'royel@gmail.com');
    ...
    //INSERT INTO `venta` (`cod_cliente`, `total`, `fecha`) VALUES ('001', '20', '22/12/22');
